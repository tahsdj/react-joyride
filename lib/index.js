...
function (_React$Component) {
  ...
  function JoyrideOverlay() {
    ...
    _defineProperty(_assertThisInitialized(_this), "getGroupStyles", function (elements) {
      ...
      var elementsSortedByPosY = _toConsumableArray(elements).sort(function (el1, el2) {
        return el1.getBoundingClientRect().y - el2.getBoundingClientRect().y;
      });

      var elementsSortedByPosX = _toConsumableArray(elements).sort(function (el1, el2) {
        return el1.getBoundingClientRect().x - el2.getBoundingClientRect().x;
      });

      var topElementPos = elementsSortedByPosY[0].getBoundingClientRect();
      var bottomElementPos = elementsSortedByPosY[elementsSortedByPosY.length - 1].getBoundingClientRect();
      var leftElementPos = elementsSortedByPosX[0].getBoundingClientRect();
      var rightElementPos = elementsSortedByPosX[elementsSortedByPosX.length - 1].getBoundingClientRect();
      var height = bottomElementPos.y - topElementPos.y + bottomElementPos.height + spotlightPadding * 2;
      var width = rightElementPos.x - leftElementPos.x + rightElementPos.width + spotlightPadding * 2;
      var isFixedTarget = hasPosition(elements[0]);
    ...
    _defineProperty(_assertThisInitialized(_this), "handleScroll", function () {
      ...
      var elements = function () {
        if (typeof target === 'string') return _toConsumableArray(document.querySelectorAll(target));

        if (Array.isArray(target)) {
          return target.reduce(function (elements, t) {
            return typeof t === 'string' ? [].concat(_toConsumableArray(elements), _toConsumableArray(document.querySelectorAll(t))) : [].concat(_toConsumableArray(elements), [getElement(t)]);
          }, []);
        }
      ...
      } else if (elements.find(function (element) {
        return hasPosition(element, 'sticky');
      })) {
        _this.updateState({});
      }
    });
  ...
  _createClass(JoyrideOverlay, [{
    ...
    value: function componentDidMount() {
      var _this$props2 = this.props,
          ...
          disableScrollParentFix = _this$props2.disableScrollParentFix,
    ...
    value: function render() {
      ...
      var spotlights = this.spotlightStyles.map(function (spotlightStyles, index) {
    ...
    get: function get() {
      ...
      var _this$props5 = this.props,
          disableScrollParentFix = _this$props5.disableScrollParentFix,
          spotlightClicks = _this$props5.spotlightClicks,
          styles = _this$props5.styles,
          target = _this$props5.target,
          group = _this$props5.group,
          paddingSize = _this$props5.paddingSize;
      ...
      if (!group || elements.length < 2) {
        return elements.map(function (element) {
          ...
          var top = getElementPosition(element, padding[1], disableScrollParentFix);
          return _objectSpread2({}, isLegacy() ? styles.spotlightLegacy : styles.spotlight, {
...
_defineProperty(JoyrideOverlay, "defaultProps", {
  group: false
});
  ...
  _createClass(JoyrideStep, [{
    ...
    value: function render() {
      ...
      return React__default.createElement("div", {
        ...
        target: Array.isArray(step.target) ? step.target[0] : step.target
