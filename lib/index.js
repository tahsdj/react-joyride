...
function (_React$Component) {
  ...
  function JoyrideOverlay() {
    ...
    _defineProperty(_assertThisInitialized(_this), "getGroupStyles", function (elements) {
      ...
      var height = bottomElementPos.y - topElementPos.y + bottomElementPos.height + padding[1] * 2;
      var width = rightElementPos.x - leftElementPos.x + rightElementPos.width + padding[0] * 2;
