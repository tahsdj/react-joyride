...
function (_React$Component) {
  ...
  _createClass(JoyrideOverlay, [{
    ...
    value: function componentDidMount() {
      ...
      var element = Array.isArray(target) ? getElement(target[0]) : getElement(target);
      ...
      var elements = function () {
        ...
        if (target && target.length > 0) {
          return target.reduce(function (elements, t) {
            return typeof t === 'string' ? [].concat(_toConsumableArray(elements), _toConsumableArray(document.querySelectorAll(t))) : [].concat(_toConsumableArray(elements), [t]);
          }, []);
        }
